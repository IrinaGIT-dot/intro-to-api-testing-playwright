...
test('Update order with valid api_key, id and body should receive code 200', async ({
  request,
}) => {
...
test("Update order status to 'INPROGRESS' with valid api_key, id and body should receive code 200", async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test("Update order status to 'DELIVERED' with valid api_key, id and body should receive code 200", async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Update order with invalid api_key, valid id and body should receive code 401', async ({
  request,
}) => {
  const requestHeaders = {
...
test('Update order with valid api_key, body and invalid id should receive code 400', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Update order with valid api_key, id and body with incorrect value in status field should receive code 400', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Update order with valid id and body, without api_key should receive code 401', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '',
...
test('Update order with valid api_key and body, without id should receive code 405', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Update order with valid api_key and body, with invalid id should receive code 400', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Delete an order data with valid api_key, id and body, response should receive code 204', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Delete an order data with an invalid id and valid api_key, response should receive code 400', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '1234567890123456',
...
test('Delete an order data with a valid id and invalid api_key, response should receive code 401', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '12345678901234',
...
test('Delete an order data with a valid id and without api_key, response should receive code 401', async ({
  request,
}) => {
  const requestHeaders = {
    api_key: '',
